...
interface Product {
  ...
  status: "Aktif" | "Nonaktif" | "Hapus"; // Status of the product
}
...
export default function ReferensiAkunList() {
              ...
              <div>
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div>
                    ...
                    <Input type="text" value="10.500.000" />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      type="text"
                      value="Pembayaran tiket untuk grup 04"
                    />
                  </div>

                  <div>
                    <Label>Tanggal</Label>
                    <Input type="text" value="20/05/2025 10:00:10" />
                  </div>
                </div>
              </div>
            </div>
